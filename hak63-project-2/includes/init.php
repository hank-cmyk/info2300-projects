...
function display_sprite($img_name, $source_link, $alt_name, $website_name){
  echo
    "<figure>
    <!-- Source:".$source_link." -->
    <img src='images/".$img_name.".png' alt='".$alt_name."'>
    <figcaption> Source: <cite><a href='".$source_link."'>".$website_name."</a></cite></figcaption>
    </figure>";
}
